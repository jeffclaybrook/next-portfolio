...
const Card = ({ icon, title, subtitle }: CardProps) => {
 return (
  <div className="flex flex-col items-center justify-center gap-3.5 bg-lightBlue shadow-sm rounded-md py-6 px-3.5">
   <span className="flex items-center justify-center bg-blue h-14 w-14 rounded-md p-3.5 text-primary">
    {icon}
   </span>
   <h4 className="text-xl tracking-wide text-secondary">{title}</h4>
